...
var percent_fem = function(){
    total_arr = pop_data.map(function(arr) {return arr["total"];});
    //    console.log(total_arr);
    total = total_arr.reduce(function(a, b) { return a+ b;});
    //    console.log(total);
    total_fem_arr = pop_data.map(function(arr){return arr["females"];});
    total_fem = total_fem_arr.reduce(function(a, b) {return a+b;});
    return total_fem / total * 100; 
}

    percent_fem(); // 51.2 %


// Percent Elderly Males (60 +)

var percent_elderly_males = function(){
    total_arr = pop_data.map(function(arr) {return arr["total"];});
    console.log(total_arr);
    total = total_arr.reduce(function(a, b) { return a+ b;});
    console.log(total);
    elderly = pop_data.filter(function(arr) { return arr["age"] >= 60;});
    console.log("elderly");
    console.log(elderly);
    elderly = elderly.map(function(arr) {return arr["males"];});
    total_e_m = elderly.reduce(function(a,b){return a+b;});
    return total_e_m / total * 100
}

    percent_elderly_males() // 6.04 %
    

var f_y = document.getElementById("fem_youth");
var p_f = document.getElementById("fem_percent");
var p_e_m = document.getElementById("eld_male");



document.getElementsByTagName("body")[0].innerHTML += "Female Youth Population in 1980:";
document.getElementsByTagName("body")[0].innerHTML += fem_youth();
document.getElementsByTagName("body")[0].innerHTML += "<br> <br>";

document.getElementsByTagName("body")[0].innerHTML += "Percent Elderly Males (60 +) in 1980:";
document.getElementsByTagName("body")[0].innerHTML += percent_elderly_males();

document.getElementsByTagName("body")[0].innerHTML += "<br> <br> <br>";
document.getElementsByTagName("body")[0].innerHTML += "Percent Females in 1980:";
document.getElementsByTagName("body")[0].innerHTML += percent_fem();
